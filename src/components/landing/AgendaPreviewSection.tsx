...
export function AgendaPreviewSection() {
  return (
    <section id="agenda" className="scroll-mt-24 flex flex-col gap-8" aria-labelledby="agenda-heading">
      <div className="flex flex-col gap-2">
        <h2 id="agenda-heading" className="font-heading text-lg font-medium text-foreground sm:text-xl">
          Programa del encuentro
        </h2>
        <p className="max-w-2xl text-sm text-muted-foreground">
          Vista previa del orden del día. La agenda detallada puede variar; consulta la versión completa en la página de eventos.
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-3">
        <Button variant="outline" asChild>
          <a href="/dev-night-talks.ics" download="dev-night-talks.ics" type="text/calendar">
