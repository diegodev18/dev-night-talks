      ...
      <CardContent className="mt-auto flex flex-col gap-4">
        <div className="flex flex-col gap-1 text-sm text-muted-foreground">
          <p className="flex items-start gap-2">
            <HugeiconsIcon icon={CalendarIcon} className="mt-0.5 shrink-0" />
    ...
    <Layout>
      <DirectionalTransition>
        ...
        <main className="flex flex-col gap-10">
          <section className="flex flex-col gap-6" aria-labelledby="events-page-heading">
            <div className="flex max-w-3xl flex-col gap-4">
              <h1 id="events-page-heading" className="font-heading text-2xl font-semibold tracking-tight text-foreground sm:text-3xl">
                Eventos
              </h1>
              <p className="text-pretty text-sm text-muted-foreground sm:text-base">
                Listado de eventos pasados y próximos de Dev Night Talks. Únete a nuestros próximos encuentros o revisa las sesiones
                anteriores.
              </p>
            </div>
            ...
            {filteredEvents.length === 0 && <p className="text-muted-foreground">No hay eventos en esta categoría.</p>}
          </section>
        </main>
        <SiteFooter />
      </DirectionalTransition>
