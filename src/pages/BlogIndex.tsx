    ...
    <Layout>
      <DirectionalTransition>
        ...
        <main className="flex flex-col gap-16">
          <section className="flex flex-col items-center gap-6 text-center" aria-labelledby="blog-hero-heading">
            <h1
          ...
          {tags.length > 0 && (
            <section className="flex flex-col gap-4" aria-labelledby="filters-heading">
          ...
          <section className="flex flex-col items-center gap-6 border-t border-border pt-16 text-center" aria-labelledby="blog-cta-heading">
            <h2 id="blog-cta-heading" className="font-heading text-xl font-medium text-foreground sm:text-2xl">
              ¿Quieres escribir en el blog?
            </h2>
            <p className="max-w-lg text-sm text-muted-foreground sm:text-base">
              Crea un archivo Markdown en{' '}
              <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-xs text-muted-foreground">content/blog/</code> con tu contenido
              y abre un Pull Request. Los pasos son:
            </p>
            <ol className="max-w-md text-left text-sm text-muted-foreground sm:text-base">
              <li className="flex gap-2">
                ...
                <span>
                  ...
                  <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-xs text-muted-foreground">feature/blog-tu-post</code>
                </span>
              </li>
              <li className="flex gap-2">
                ...
                <span>
                  Crea tu archivo{' '}
                  <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-xs text-muted-foreground">content/blog/tu-post.md</code>{' '}
                  con frontmatter y contenido
                </span>
              </li>
              <li className="flex gap-2">
                <span className="shrink-0 font-mono text-primary">3.</span>
                <span>
                  Abre un PR siguiendo la{' '}
                  <a
